...
- Update version of node manager used in fixtures [\#121](https://github.com/puppetlabs/puppetlabs-pe_databases/pull/121) ([elainemccloskey](https://github.com/elainemccloskey))
